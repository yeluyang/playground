...
impl ::protobuf::Message for LogSeq {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<LogSeq>(
                    "LogSeq",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static LogSeq {
        static mut instance: ::protobuf::lazy::Lazy<LogSeq> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const LogSeq,
        };
        unsafe {
...
pub struct VoteRequest {
    // message fields
    pub candidate: ::protobuf::SingularPtrField<EndPoint>,
    pub term: i64,
...
impl VoteRequest {
    ...
    pub fn get_candidate(&self) -> &EndPoint {
        self.candidate.as_ref().unwrap_or_else(|| EndPoint::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_candidate(&mut self, v: EndPoint) {
        self.candidate = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_candidate(&mut self) -> &mut EndPoint {
    ...
    // Take field
    pub fn take_candidate(&mut self) -> EndPoint {
        self.candidate.take().unwrap_or_else(|| EndPoint::new())
    }
...
pub struct VoteResponse {
    // message fields
    pub peer: ::protobuf::SingularPtrField<EndPoint>,
    pub term: i64,
    pub last_log_seq: ::protobuf::SingularPtrField<LogSeq>,
    pub granted: bool,
    // special fields
...
impl VoteResponse {
    ...
    pub fn get_peer(&self) -> &EndPoint {
        self.peer.as_ref().unwrap_or_else(|| EndPoint::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_peer(&mut self, v: EndPoint) {
        self.peer = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_peer(&mut self) -> &mut EndPoint {
    ...
    // Take field
    pub fn take_peer(&mut self) -> EndPoint {
        self.peer.take().unwrap_or_else(|| EndPoint::new())
    }
...
impl ::protobuf::Message for VoteResponse {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<EndPoint>>(
                    "peer",
                    |m: &VoteResponse| { &m.peer },
                    |m: &mut VoteResponse| { &mut m.peer },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                    "term",
                ...
                ::protobuf::reflect::MessageDescriptor::new::<VoteResponse>(
                    "VoteResponse",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static VoteResponse {
        static mut instance: ::protobuf::lazy::Lazy<VoteResponse> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const VoteResponse,
        };
        unsafe {
...
pub struct AppendRequest {
    // message fields
    pub leader: ::protobuf::SingularPtrField<EndPoint>,
    pub term: i64,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
...
impl AppendRequest {
    ...
    pub fn get_leader(&self) -> &EndPoint {
        self.leader.as_ref().unwrap_or_else(|| EndPoint::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_leader(&mut self, v: EndPoint) {
        self.leader = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_leader(&mut self) -> &mut EndPoint {
    ...
    // Take field
    pub fn take_leader(&mut self) -> EndPoint {
        self.leader.take().unwrap_or_else(|| EndPoint::new())
    }
...
pub struct AppendResponse {
    // message fields
    pub follower: ::protobuf::SingularPtrField<EndPoint>,
    pub term: i64,
    pub success: bool,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
...
impl AppendResponse {
    ...
    pub fn get_follower(&self) -> &EndPoint {
        self.follower.as_ref().unwrap_or_else(|| EndPoint::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_follower(&mut self, v: EndPoint) {
        self.follower = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_follower(&mut self) -> &mut EndPoint {
        if self.follower.is_none() {
            self.follower.set_default();
        }
        self.follower.as_mut().unwrap()
    }

    // Take field
    pub fn take_follower(&mut self) -> EndPoint {
        self.follower.take().unwrap_or_else(|| EndPoint::new())
    }
...
impl ::protobuf::Message for AppendResponse {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.follower)?;
                },
                2 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        if let Some(ref v) = self.follower.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
        if self.term != 0 {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<EndPoint>>(
                    "follower",
                    |m: &AppendResponse| { &m.follower },
                    |m: &mut AppendResponse| { &mut m.follower },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                    "term",
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x02\x20\x01(\x03R\x05index\"u\n\x0bVoteRequest\x12'\n\tcandidate\
    \x18\x01\x20\x01(\x0b2\t.EndPointR\tcandidate\x12\x12\n\x04term\x18\x02\
    \x20\x01(\x03R\x04term\x12)\n\x0clast_log_seq\x18\x03\x20\x01(\x0b2\x07.\
    LogSeqR\nlastLogSeq\"\x86\x01\n\x0cVoteResponse\x12\x1d\n\x04peer\x18\
    \x01\x20\x01(\x0b2\t.EndPointR\x04peer\x12\x12\n\x04term\x18\x02\x20\x01\
    (\x03R\x04term\x12)\n\x0clast_log_seq\x18\x03\x20\x01(\x0b2\x07.LogSeqR\
    \nlastLogSeq\x12\x18\n\x07granted\x18\x04\x20\x01(\x08R\x07granted\"F\n\
    \rAppendRequest\x12!\n\x06leader\x18\x01\x20\x01(\x0b2\t.EndPointR\x06le\
    ader\x12\x12\n\x04term\x18\x02\x20\x01(\x03R\x04term\"e\n\x0eAppendRespo\
    nse\x12%\n\x08follower\x18\x01\x20\x01(\x0b2\t.EndPointR\x08follower\x12\
    \x12\n\x04term\x18\x02\x20\x01(\x03R\x04term\x12\x18\n\x07success\x18\
    \x03\x20\x01(\x08R\x07success2^\n\x08PeerGRPC\x12%\n\x04Vote\x12\x0c.Vot\
    eRequest\x1a\r.VoteResponse\"\0\x12+\n\x06Append\x12\x0e.AppendRequest\
    \x1a\x0f.AppendResponse\"\0J\xc9\r\n\x06\x12\x04\0\06\x01\n\x08\n\x01\
    \x0c\x12\x03\0\0\x12\n\n\n\x02\x04\0\x12\x04\x02\0\x05\x01\n\n\n\x03\x04\
    \0\x01\x12\x03\x02\x08\x10\n\x0b\n\x04\x04\0\x02\0\x12\x03\x03\x04\x12\n\
    ...
    \x03\x07\x08\x0e\n\x1f\n\x04\x04\x01\x02\0\x12\x03\t\x04\x13\x1a\x12\x20\
    term\x20of\x20last\x20log\n\n\r\n\x05\x04\x01\x02\0\x04\x12\x04\t\x04\
    \x07\x10\n\x0c\n\x05\x04\x01\x02\0\x05\x12\x03\t\x04\t\n\x0c\n\x05\x04\
    \x01\x02\0\x01\x12\x03\t\n\x0e\n\x0c\n\x05\x04\x01\x02\0\x03\x12\x03\t\
    \x11\x12\n\x20\n\x04\x04\x01\x02\x01\x12\x03\x0b\x04\x14\x1a\x13\x20inde\
    x\x20of\x20last\x20log\n\n\r\n\x05\x04\x01\x02\x01\x04\x12\x04\x0b\x04\t\
    \x13\n\x0c\n\x05\x04\x01\x02\x01\x05\x12\x03\x0b\x04\t\n\x0c\n\x05\x04\
    \x01\x02\x01\x01\x12\x03\x0b\n\x0f\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\
    \x03\x0b\x12\x13\n\n\n\x02\x04\x02\x12\x04\x0e\0\x15\x01\n\n\n\x03\x04\
    \x02\x01\x12\x03\x0e\x08\x13\n\x1e\n\x04\x04\x02\x02\0\x12\x03\x10\x04\
    \x1b\x1a\x11\x20id\x20of\x20candidate\n\n\r\n\x05\x04\x02\x02\0\x04\x12\
    \x04\x10\x04\x0e\x15\n\x0c\n\x05\x04\x02\x02\0\x06\x12\x